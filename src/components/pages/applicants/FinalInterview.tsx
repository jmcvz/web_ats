...
>
  ...
  variant="outline"
  size="sm"
  className="w-full px-1 lg:px-3 bg-white text-red-600 border border-red-500 hover:bg-red-500 hover:text-white text-xs lg:text-sm h-7 lg:h-10 lg:whitespace-nowrap"
>
  Fail
</Button>
