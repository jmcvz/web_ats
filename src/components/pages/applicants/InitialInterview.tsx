  ...
  >
    ...
    variant="outline"
    size="sm"
    className="w-full px-1 lg:px-3 h-7 lg:h-10 text-xs lg:text-sm text-red-600 border-red-500 bg-white hover:bg-red-500 hover:text-white transition"
  >
    Fail
  </Button>
  ...
  onClick={() => navigate(`/job/${jobtitle}/applicant/${applicant.id}/full-result`, {
