...
export default function PositionsOnHold() {
      ...
      <div className="min-h-screen bg-white p-6 pt-[100px]">
        <div className="mx-auto max-w-7xl space-y-6">
          ...
          <div className="flex justify-between items-center border-b pb-2">
            <Tabs value="on-hold" onValueChange={handleTabChange} className="flex-1">
          ...
          <div className="space-y-2">
            {filteredPostings.map((posting, idx) => (
              <Card key={idx} className="p-4 shadow-sm hover:shadow-md transition border">
                <div className="flex justify-between items-start">
                  <div>
                    <div className="flex items-center gap-2">
                      <h3 className="text-base font-semibold text-gray-800">{posting.title}</h3>
                      <Badge variant="secondary" className={getDepartmentColor(posting.department)}>
                        {posting.department}
                      </Badge>
                    </div>
