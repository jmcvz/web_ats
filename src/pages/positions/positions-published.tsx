...
const postings = [
  {
    ...
    link: "https://oodc.yourcompany.com/jobs/social-media-manager",
  },
  {
    ...
    link: "https://oodc.yourcompany.com/jobs/web-developer",
  },
  {
    ...
    link: "https://oodc.yourcompany.com/jobs/hr-coordinator",
  },
  {
    ...
    link: "https://oodc.yourcompany.com/jobs/marketing-specialist",
  },
  {
    ...
    link: "https://oodc.yourcompany.com/jobs/social-media-content",
  },
  {
    ...
    link: "https://oodc.yourcompany.com/jobs/marketing-manager",
  },
]
...
export default function PositionsPublished() {
      ...
      <div className="min-h-screen bg-white p-6 pt-[100px]">
        <div className="mx-auto max-w-7xl space-y-6">
          ...
          <div className="flex justify-between items-center border-b pb-2">
            <Tabs value="published" onValueChange={handleTabChange} className="flex-1">
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <div
                    ...
                    onClick={() => handleShareClick(posting.link)}
                  >
                    Published
