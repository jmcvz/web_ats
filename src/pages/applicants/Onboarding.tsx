...
export default function OnboardingPage() {
  ...
  const handleMarkComplete = (applicant: any) => {
    ...
    // Here you would update the applicant's status
  }
        ...
        <div className="flex items-center gap-4">
          ...
          <Select defaultValue="onboarding">
            <SelectTrigger className="w-64">
              <SelectValue className="font-bold" placeholder="ONBOARDING" />
            </SelectTrigger>
            <SelectContent>
  ...
  <TabsList className="grid grid-cols-2 max-w-md w-full sm:w-auto">
    ...
    <TabsTrigger value="complete">Complete</TabsTrigger>
        ...
        {filteredApplicants.length === 0 && (
          <div className="text-center py-8 text-gray-500">No {activeTab} applicants found matching your criteria.</div>
        )}
      </div>
    </div>
    </>
