...
import AnsweredForm from "@/forms/AnsweredForm"
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h4 className="font-medium text-gray-900">John_Doe_Resume.pdf</h4>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h4 className="font-medium text-gray-900">Cover_Letter_John_Doe.docx</h4>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h4 className="font-medium text-gray-900">Profile_Photo_2x2.jpg</h4>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h4 className="font-medium text-gray-900">Medical_Certificate_2023.pdf</h4>
